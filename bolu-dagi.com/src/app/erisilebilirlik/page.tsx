...
export const metadata: Metadata = {
  title: "Erişilebilirlik | Bolu Dağı Rehberi",
  description:
    "Bolu Dağı Rehberi erişilebilirlik taahhüdü. WCAG 2.1 AA standartlarına uygun, herkes için erişilebilir bir deneyim sunuyoruz.",
};
      ...
      <main id="main-content" className="pt-28 pb-20 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-green max-w-none text-muted-foreground space-y-6 text-base leading-relaxed">
            ...
            <p>
              Bolu Dağı Rehberi olarak, web sitemizin engelli bireyler dahil
            ...
            <p>
              <a
                href="mailto:info@bolu-dagi.com"
