              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="space-y-0">
                  ...
                  <CategoryToggle
                    ...
                    description="Ziyaretçi istatistikleri toplamamıza yardımcı olur."
                  ...
                  <CategoryToggle
                    ...
                    description="Kişiselleştirilmiş reklam gösterimi için kullanılır."
                  ...
                  <CategoryToggle
                    ...
                    description="Tercih ve ayarlarınızı hatırlamamızı sağlar."
