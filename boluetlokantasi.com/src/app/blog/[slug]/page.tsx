    ...
    <article className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-10 md:py-12">
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-3 sm:mb-4">
        <Link
          ...
          className="bg-amber-100 text-amber-800 px-2.5 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium hover:bg-amber-200 active:bg-amber-300 transition-colors"
        >
          {post.category}
        </Link>
      ...
      {post.cover_image && (
        <div className="aspect-video rounded-xl overflow-hidden mb-6 sm:mb-8 shadow-md -mx-4 sm:mx-0">
          <img
      ...
      <div
        className="prose prose-lg max-w-none prose-headings:text-stone-900 prose-a:text-amber-800 prose-strong:text-stone-800 prose-li:text-stone-700"
        ...
        <div className="flex flex-wrap gap-2 mt-8 sm:mt-10 pt-4 sm:pt-6 border-t border-stone-200">
          {post.tags.split(",").map((tag: string) => (
            <Link
              ...
              className="bg-stone-100 text-stone-600 hover:bg-amber-50 hover:text-amber-800 px-2.5 sm:px-3 py-1 rounded-full text-xs sm:text-sm transition-colors"
            >
              #{tag.trim()}
            </Link>
          ))}
      ...
      <div className="mt-8 sm:mt-10">
        <Link
          href="/blog"
          className="text-amber-800 hover:text-amber-900 font-medium text-sm sm:text-base"
        >
