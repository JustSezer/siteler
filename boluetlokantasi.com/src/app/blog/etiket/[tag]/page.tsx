...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `"${decodedTag}" etiketli tüm yazılar. Bolu yemekleri, et kültürü ve ${decodedTag} hakkında içerikler.`,
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10 md:py-12">
      ...
      <div className="mt-10 text-center">
        <Link href="/blog" className="text-amber-800 hover:text-amber-900 font-medium text-sm">
