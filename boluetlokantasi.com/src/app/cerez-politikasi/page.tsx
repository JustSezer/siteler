...
export const metadata: Metadata = {
  title: "Çerez Politikası | Bolu Et Lokantası Rehberi",
  description: "Bolu Et Lokantası Rehberi çerez politikası.",
  alternates: {
    canonical: "https://boluetlokantasi.com/cerez-politikasi",
  },
};
