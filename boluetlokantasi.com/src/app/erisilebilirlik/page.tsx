...
export const metadata: Metadata = {
  title: "Erişilebilirlik | Bolu Et Lokantası",
  description:
    "Bolu Et Lokantası erişilebilirlik taahhüdü. WCAG 2.1 AA standartlarına uygun, herkes için erişilebilir bir deneyim sunuyoruz.",
  alternates: {
    canonical: "https://boluetlokantasi.com/erisilebilirlik",
  },
};
      ...
      <main id="main-content" className="pt-28 pb-20 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose-custom space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              Bolu Et Lokantası olarak, web sitemizin engelli bireyler dahil
