...
export const metadata: Metadata = {
  title: "Kullanım Şartları | Bolu Et Lokantası Rehberi",
  description: "Bolu Et Lokantası Rehberi kullanım şartları.",
  alternates: {
    canonical: "https://boluetlokantasi.com/kullanim-sartlari",
  },
};
      ...
      <main className="pt-28 pb-20 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose-custom space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              boluetlokantasi.com (&quot;Site&quot;) web sitesini kullanarak bu
            ...
            <p>
              Sitedeki tüm metin, grafik ve tasarım öğeleri boluetlokantasi.com
