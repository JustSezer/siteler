  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full px-3 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none text-sm font-mono"
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
        <label htmlFor="excerpt" className="block text-sm font-medium text-stone-700 mb-1">
          Özet *
        </label>
        <textarea
          id="excerpt"
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
        ...
        <textarea
          ...
          required
          rows={10}
          className="w-full px-3 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none text-sm font-mono resize-y min-h-[240px] sm:min-h-[360px]"
      ...
      {/* Meta */}
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 space-y-4">
        <h3 className="font-semibold text-stone-800">Yazı Detayları</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              maxLength={50}
              className="w-full px-3 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none text-sm"
              placeholder="Bolu Mutfağı"
            />
          </div>
          <div>
            <label htmlFor="readingTime" className="block text-sm font-medium text-stone-700 mb-1">
              Okuma Süresi (dk)
            </label>
            <input
              type="number"
        ...
        <div>
          ...
          <input
            ...
            maxLength={500}
            className="w-full px-3 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none text-sm"
            placeholder="bolu, et, lokanta (virgülle ayırın)"
          />
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm font-medium text-stone-700">Taslak</span>
            </label>
          </div>
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            <Link
              href="/admin"
              className="flex-1 sm:flex-initial text-center border border-stone-300 text-stone-700 hover:bg-stone-50 font-medium px-5 py-2.5 rounded-lg text-sm transition-colors"
            >
              İptal
            </Link>
            <button
              type="submit"
              disabled={saving}
              className="flex-1 sm:flex-initial bg-amber-800 hover:bg-amber-900 disabled:bg-amber-400 text-white font-medium px-5 py-2.5 rounded-lg text-sm transition-colors"
            >
