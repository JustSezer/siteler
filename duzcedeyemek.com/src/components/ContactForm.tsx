...
export default function ContactForm() {
  ...
  return (
    <div className="bg-white border border-stone-100 rounded-xl p-5 sm:p-6 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="message" className="block text-sm font-bold text-stone-700 mb-1">
            Mesajınız
          </label>
          <textarea
            id="message"
        ...
        <button
          type="submit"
          disabled={status === "loading"}
          className="w-full bg-orange-600 hover:bg-orange-700 active:bg-orange-800 disabled:bg-orange-300 text-white font-bold py-2.5 rounded-xl transition-colors text-sm"
        >
