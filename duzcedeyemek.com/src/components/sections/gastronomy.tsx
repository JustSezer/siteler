...
const dishes = [
  ...
  },
  {
    ...
    desc: "Mısır unu, lahana ve tereyağı. Soğuk kış günlerinin vazgeçilmez sıcak lezzeti.",
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        >
          <h2 className="font-serif text-[clamp(2rem,5vw,4rem)] font-black text-primary leading-[1] tracking-tight mb-4">
            Sofranın <span className="italic text-secondary font-light">altı</span> lezzeti.
          </h2>
