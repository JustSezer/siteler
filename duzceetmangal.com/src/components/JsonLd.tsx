...
export function WebSiteSchema() {
  const schema = {
    ...
    url: SITE_URL,
    description:
      "Düzce'nin en lezzetli et mangal deneyimi. Mangal tarifleri, et rehberi ve ızgara teknikleri.",
    inLanguage: "tr",
    publisher: {
      "@type": "Organization",
...
export function LocalBusinessSchema() {
  const schema = {
    ...
    image:
      "https://images.pexels.com/photos/1927377/pexels-photo-1927377.jpeg?auto=compress&cs=tinysrgb&w=1200",
    url: "https://ibrahiminyeri.com",
    telephone: PHONE,
    priceRange: "₺₺",
