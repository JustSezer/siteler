...
export const metadata: Metadata = {
  ...
  description: "Et & Mangal çerez politikası. Hangi çerezlerin kullanıldığı ve nasıl yönetildiği hakkında bilgi.",
};
    ...
    <>
      ...
      <main className="pt-28 pb-20 bg-paper">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-none text-ink-soft space-y-6 text-base leading-relaxed">
            ...
            <p>
              ...
              <a href="mailto:info@et-mangal.com" className="text-ember underline">info@et-mangal.com</a> adresinden
