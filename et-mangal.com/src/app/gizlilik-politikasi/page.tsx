...
export const metadata: Metadata = {
  title: "Gizlilik Politikası | Et & Mangal",
  description: "Et & Mangal gizlilik politikası. Kişisel verilerinizin nasıl toplandığı, kullanıldığı ve korunduğu hakkında bilgi.",
  alternates: {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-10 md:py-12">
      ...
      <div className="prose prose-lg max-w-none text-stone-700 space-y-6">
        <p>
          Bu gizlilik politikası, <strong>et-mangal.com</strong> ("Site") tarafından toplanan,
