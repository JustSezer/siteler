    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-stone-500 text-sm mt-1">Et & Mangal Yönetim</p>
        </div>
        <div className="flex gap-3">
          <Link
            href="/admin/posts/new"
            className="bg-red-700 hover:bg-red-800 text-white font-medium px-4 py-2 rounded-lg text-sm transition-colors"
          >
            + Yeni Yazı
          </Link>
          <Link
            href="/admin/settings"
            className="border border-stone-300 text-stone-700 hover:bg-stone-50 font-medium px-4 py-2 rounded-lg text-sm transition-colors"
          >
            Ayarlar
          </Link>
          <Link
          ...
          <button
            ...
            className="border border-stone-300 text-stone-500 hover:text-red-700 hover:border-red-300 font-medium px-4 py-2 rounded-lg text-sm transition-colors"
          >
            Çıkış
          </button>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        {posts.length === 0 ? (
          <div className="p-8 text-center text-stone-500">
            Henüz yazı yok.{" "}
            <Link href="/admin/posts/new" className="text-red-700 hover:text-red-800 font-medium">
              İlk yazını oluştur
            </Link>
          </div>
        ) : (
                  ...
                  <tr key={post.id} className="hover:bg-stone-50 transition-colors">
                    <td className="px-4 sm:px-6 py-3">
                      <Link
                        ...
                        className="font-medium text-stone-800 hover:text-red-700 line-clamp-1"
                      >
                        {post.title}
                      </Link>
