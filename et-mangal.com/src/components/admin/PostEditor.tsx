    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full px-3 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none text-sm font-mono"
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
        ...
        <textarea
          ...
          required
          rows={16}
          className="w-full px-3 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none text-sm font-mono resize-y"
      ...
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            maxLength={500}
            className="w-full px-3 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none text-sm"
            placeholder="et, mangal, tarif (virgülle ayırın)"
          />
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            ...
            <button
              type="submit"
              disabled={saving}
              className="flex-1 sm:flex-initial bg-red-700 hover:bg-red-800 disabled:bg-red-400 text-white font-medium px-5 py-2.5 rounded-lg text-sm transition-colors"
            >
