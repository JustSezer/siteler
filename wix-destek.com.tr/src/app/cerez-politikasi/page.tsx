...
export const metadata: Metadata = {
  ...
  description:
    "Wix Destek TR web sitesinin çerez kullanım politikası. Hangi çerezleri kullandığımız ve tercihlerinizi nasıl yönetebileceğiniz.",
  ...
  return (
    <article className="mx-auto max-w-3xl px-5 lg:px-6 py-16 prose-content">
      ...
      <div className="mt-8 space-y-6 text-[var(--ink-soft)] leading-relaxed">
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">1. Çerez nedir?</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">2. Hangi çerezleri kullanıyoruz?</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">3. Tercihlerinizi nasıl yönetebilirsiniz?</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">4. İletişim</h2>
          <p className="mt-2">
            Çerez politikamıza dair sorularınız için <a href={`mailto:${SITE.email}`} className="text-[var(--orange)] underline underline-offset-2">{SITE.email}</a> adresinden bize ulaşabilirsiniz.
          </p>
        </section>
      </div>
    </article>
