    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="mx-auto max-w-5xl px-5 lg:px-6 pt-6">
        <ol className="flex items-center gap-2 text-xs text-[var(--ink-mute)]">
          <li><Link href="/" className="hover:text-[var(--navy)]">Ana Sayfa</Link></li>
          <li aria-hidden="true">/</li>
          <li><Link href="/hizmetler" className="hover:text-[var(--navy)]">Hizmetler</Link></li>
          <li aria-hidden="true">/</li>
      ...
      <section className="mx-auto max-w-5xl px-5 lg:px-6 py-10 lg:py-14">
        ...
        <h1 className="text-4xl lg:text-5xl font-bold text-[var(--navy)] leading-[1.1] tracking-tight">
          {service.title}
        </h1>
        ...
        <div className="mt-7 flex flex-wrap items-center gap-6 pb-2">
          {service.duration && (
            <div>
              ...
              <p className="text-xl font-bold text-[var(--navy)]">{service.duration}</p>
            </div>
          )}
          <div>
            <p className="text-xs uppercase tracking-wide text-[var(--ink-mute)] font-semibold">
            ...
            <p className="text-xl font-bold text-[var(--navy)]">Kapsama göre</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-5 lg:px-6 pb-10">
        <div className="grid lg:grid-cols-2 gap-10">
          <div>
            <h2 className="text-2xl font-bold text-[var(--navy)]">Kapsam</h2>
              ...
              {service.bullets.map((b) => (
                <li key={b} className="flex items-start gap-3 text-[var(--ink-soft)] leading-relaxed">
                  <span
                    ...
                    aria-hidden="true"
                  >
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="var(--orange-active)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="mt-10">
              <h2 className="text-2xl font-bold text-[var(--navy)]">Neden biz?</h2>
          ...
          <div className="card p-6 lg:p-7 h-fit lg:sticky lg:top-24">
            <h2 className="text-xl font-bold text-[var(--navy)]">Teklif alın</h2>
            <p className="mt-1.5 text-sm text-[var(--ink-soft)]">
              Formu doldurun, 24 saat içinde net teklifle dönelim.
            </p>
            <div className="mt-5">
              <ContactForm compact />
            </div>
      ...
      {related.length > 0 && (
        <section className="bg-[var(--surface)] mt-16">
          <div className="mx-auto max-w-5xl px-5 lg:px-6 py-16">
            <h2 className="text-2xl font-bold text-[var(--navy)]">Benzer hizmetler</h2>
            <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {related.map((r) => (
                ...
                >
                  <h3 className="text-base font-bold text-[var(--navy)] group-hover:text-[var(--orange)]">
                    {r.shortTitle}
                  </h3>
