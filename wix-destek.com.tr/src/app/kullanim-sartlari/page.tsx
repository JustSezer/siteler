...
export const metadata: Metadata = {
  ...
  description:
    "Wix Destek TR web sitesi ve hizmet kullanım şartları. Sitenin ve hizmetlerin kullanımını düzenleyen genel koşullar.",
  ...
  return (
    <article className="mx-auto max-w-3xl px-5 lg:px-6 py-16 prose-content">
      ...
      <div className="mt-8 space-y-6 text-[var(--ink-soft)] leading-relaxed">
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">1. Taraflar</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">2. Hizmet kapsamı</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">3. Wix ile ilişkimiz</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">4. Ödeme ve iade</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">5. Garanti ve sorumluluk</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">6. Fikri mülkiyet</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">7. Uygulanacak hukuk</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--navy)]">8. İletişim</h2>
          <p className="mt-2">
            Bu şartlarla ilgili sorularınız için{" "}
            <a href={`mailto:${SITE.email}`} className="text-[var(--orange)] underline underline-offset-2">{SITE.email}</a> adresinden bize ulaşabilirsiniz.
          </p>
        </section>
      </div>
    </article>
