...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    cover: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&h=900&fit=crop&auto=format&q=80",
    coverAlt: "Analitik dashboard ve SEO grafikleri gösteren laptop ekranı",
    intro: [
...

  {
    ...
    cover: "https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=1600&h=900&fit=crop&auto=format&q=80",
    coverAlt: "İki seçenek arasında kalmış karar verme anı",
    intro: [
...

  {
    ...
    cover: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1600&h=900&fit=crop&auto=format&q=80",
    coverAlt: "Karanlık ekranda kırmızı hata kodları",
    intro: [
...

  {
    ...
    cover: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1600&h=900&fit=crop&auto=format&q=80",
    coverAlt: "Sunucu ışıkları ve ağ kabloları",
    intro: [
    ...
    ctaBody:
      "Domain bağlama hizmetimiz: DNS, SSL ve e-posta kayıtları dahil, aynı gün teslim. Kapsama göre sabit teklif.",
...

  {
    ...
    cover: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1600&h=900&fit=crop&auto=format&q=80",
    coverAlt: "Kredi kartı ile online ödeme yapan kullanıcı",
    intro: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yöntem 1 evet (link/form). Yöntem 2 için Velo kod parçası gerekir. Kendiniz yapamıyorsanız kapsama göre sabit teklifle biz kuruyoruz.",
      },
    ],
...

  {
    ...
    cover: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1600&h=900&fit=crop&auto=format&q=80",
    coverAlt: "Performans grafikleri gösteren analitik ekranı",
    intro: [
...

  {
    ...
    cover: "https://images.unsplash.com/photo-1526925539332-aa3b66e35444?w=1600&h=900&fit=crop&auto=format&q=80",
    coverAlt: "Dünya haritası ve çok dilli iletişim simgeleri",
    intro: [
    ...
    ctaBody:
      "Wix multilingual kurulumu + 5 sayfa profesyonel Türkçe→İngilizce çeviri. Kapsama göre sabit teklif.",
    relatedSlugs: ["wix-seo-rehberi-2026"],
  },

  {
    ...
    cover: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=1600&h=900&fit=crop&auto=format&q=80",
    coverAlt: "Hesap makinesi, grafik ve fiyatlandırma analizleri",
    intro: [
