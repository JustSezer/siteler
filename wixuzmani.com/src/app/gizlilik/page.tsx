...
export const metadata: Metadata = {
  ...
  description:
    "Wix Uzmanı kişisel verilerinizi nasıl topladığı, işlediği ve koruduğuyla ilgili gizlilik politikası. KVKK aydınlatma metni.",
  ...
  return (
    <article className="mx-auto max-w-3xl px-5 lg:px-6 py-16 prose-content">
      ...
      <div className="mt-8 space-y-6 text-[var(--ink-soft)] leading-relaxed">
        <section>
          <h2 className="text-xl font-bold text-[var(--emerald-900)]">1. Veri sorumlusu</h2>
          <p className="mt-2">
            Kişisel verilerinizin işlenmesi konusunda veri sorumlusu
            <strong> {SITE.fullName}</strong>'dir ({SITE.domain}). İletişim:{" "}
            <a href={`mailto:${SITE.email}`} className="text-[var(--bronze)] underline underline-offset-2">{SITE.email}</a>
          </p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-[var(--emerald-900)]">2. Hangi verileri topluyoruz?</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--emerald-900)]">3. Verilerinizi neden işliyoruz?</h2>
          <ul className="mt-2 list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--emerald-900)]">4. Verileriniz kimlerle paylaşılır?</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--emerald-900)]">5. Verileriniz ne kadar saklanır?</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--emerald-900)]">6. KVKK kapsamındaki haklarınız</h2>
          <p className="mt-2">
          ...
          <p className="mt-2">
            Talepleriniz için <a href={`mailto:${SITE.email}`} className="text-[var(--bronze)] underline underline-offset-2">{SITE.email}</a> adresine yazın. 30 gün içinde yanıt veriyoruz.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-[var(--emerald-900)]">7. Güvenlik</h2>
          <p className="mt-2">
