...
const STORAGE_KEY = "wixuzmani-cookie-consent";
  ...
  return (
    ...
    >
      <div className="card shadow-lg">
        <h2 id="cookie-title" className="text-base font-bold text-[var(--emerald-900)] mb-1.5">
          Çerez tercihiniz
        </h2>
        <p className="text-sm text-[var(--ink-soft)] leading-relaxed">
          Siteyi geliştirmek için temel çerezler kullanıyoruz. Tüm tercihleri{" "}
          <Link href="/cerez-politikasi" className="text-[var(--bronze)] underline underline-offset-2">
            çerez politikasında
          </Link>{" "}
          inceleyebilirsiniz.
        </p>
